...
# Licensed under the AGPL-3.0 License. You should have received a copy of the GNU Affero General Public License along with CCBot. If not, see <https://www.gnu.org/licenses/>.
